...
class search:
    ...
    def find(self, search, delay=0, head_less=False):
                    ...
                    for d2 in div1:
                        ...
                        for f in fig:
                            ...
                            for ar in div3:
                                ...
                                for d4 in div4:
                                    dx = d4.find_elements_by_class_name('_6IG7')
                                    for dx1 in dx:
                                        d5 = dx1.find_elements_by_class_name('_1hIRM')
                                        for a in d5:
...
def filter_by_tag(self, tag, delay=0):
    """ Search for stock free images from unsplash.com using
    tag name
